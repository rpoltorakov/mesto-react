export default function PopupWithForm({isOpen, onClose, target, title, children, button}) {
  ...
  return (
    <div className={`popup  popup_target_${target} ${isOpen ? 'popup_opened' : ''}`}>
      <div className="popup__container">
        ...
        <form className={`popup__form popup__form_target_${target}`} name={target} noValidate>
          {children}
